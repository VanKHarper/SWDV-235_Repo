...
<!-- Van - 5/2/2019 - Got part of comm3 Query to update Disk_Status properly -->
<!-- Van - 5/3/2019 - Fixed Updating Status Object Error -->
<!-- Van - 5/3/2019 - Re-Created and added onto Stored Procedures -->
<!-- Van - 5/3/2019 - Added aditional values to DropDownList -->
<!-- Van - 5/4/2019 - Fixed issue with duplicate disks by adding a Delete Procedure -->
<!-- Van - 5/4/2019 - Added autodate for Borrowed_Date and Removed Calendar -->
<!-- Van - 5/4/2019 - Added autodate for Expected_Date -->
<!-- Van - 5/4/2019 - Fixed some Cosmetic issues with inline styles and CSS page  -->
--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <form id="form1" runat="server" class="form-horizontal">
        ...
        <div class="col-xs-11" style="margin-left: 62.5%;">
             <h3>Disk Checkout</h3>
            <p>
